...
* Date/Publication: 2020-09-23 17:20:03 UTC
...
* Date/Publication: 2020-09-16 13:30:03 UTC
* Number of recursive dependencies: 105
...
*   checking tests ...
    ...
    ...
       ...
       12.       └─plotly::gg2list(...)
       13.         └─grDevices:::dev_fun(...)
      
      ── Warning (test-tk_tbl.R:19:1): (code run outside of `test_that()`) ───────────
      ...
      ══ testthat results  ═══════════════════════════════════════════════════════════
      Warning (test-rsample-time_series_cv.R:149:1): (code run outside of `test_that()`)
      ERROR (test-rsample-time_series_cv.R:149:1): (code run outside of `test_that()`)
      Warning (test-tk_tbl.R:19:1): (code run outside of `test_that()`)
      
      [ FAIL 1 | WARN 2 | SKIP 0 | PASS 392 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking whether package ‘treeHMM’ can be installed ... WARNING
    ...
    See ‘/c4/home/henrik/repositories/globals/revdep/checks/treeHMM/new/treeHMM.Rcheck/00install.out’ for details.
    ```
